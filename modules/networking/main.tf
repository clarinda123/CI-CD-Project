...
resource "aws_subnet" "pubsn_web_az1" {
  ...
  tags = merge(local.common_tags,
    {
      Name = "${var.project_name}-pubsn_az1-${var.Environment}"
    }
  )
}
...
resource "aws_subnet" "pubsn_web_az2" {
  ...
  tags = merge(local.common_tags,
    {
      Name = "${var.project_name}-pubsn_az2-${var.Environment}"
    }
  )
}
...
resource "aws_route_table" "pubrt_web" {
  ...
  tags = merge(local.common_tags,
    {
      Name = "${var.project_name}-pubrt-${var.Environment}"
    }
  )
}
...
resource "aws_subnet" "privsn_app_az1" {
  ...
  tags = merge(local.common_tags,
    {
      Name = "${var.project_name}-privsn_az1-${var.Environment}"
    }
  )
}
...
resource "aws_subnet" "privsn_app_az2" {
  ...
  tags = merge(local.common_tags,
    {
      Name = "${var.project_name}-privsn_app_az2-${var.Environment}"
    }
  )
}
...
resource "aws_subnet" "privsn_db_az1" {
  ...
  tags = merge(local.common_tags,
    {
      Name = "${var.project_name}-privsn_db_az1-${var.Environment}"
    }
  )
}
...
resource "aws_subnet" "privsn_db_az2" {
  ...
  tags = merge(local.common_tags,
    {
      Name = "${var.project_name}-privsn_db_az2-${var.Environment}"
    }
  )
}
...
resource "aws_route_table" "privrt_az1" {
  ...
  tags = merge(local.common_tags,
    {
      Name = "${var.project_name}-privrt_az1-${var.Environment}"
    }
  )
}
...
resource "aws_route_table" "privrt_az2" {
  ...
  tags = merge(local.common_tags,
    {
      Name = "${var.project_name}-privrt_az2-${var.Environment}"
    }
  )
}
...
resource "aws_nat_gateway" "nat_gw_az1" {
  ...
  tags = merge(local.common_tags,
    {
      "Name" = "${var.project_name}-ngw_az1-${var.Environment}"
    }
   )
  }
  ...
  tags = merge(local.common_tags,
    {
      "Name" = "${var.project_name}-ngw_az2-${var.Environment}"
    }
   )
  }
