...
resource "aws_iam_role" "eks_cluster_role" {
  name               = "${var.project_name}-eks_cluster_role-${var.Environment}"
...
resource "aws_eks_cluster" "eks_cluster" {
  name     = "${var.project_name}-eks_cluster-${var.Environment}"
...
resource "aws_iam_role" "nodegroup-role" {
  name = "${var.project_name}-nodegroup-role-${var.Environment}"
...
resource "aws_eks_node_group" "node_group" {
  ...
  node_group_name = "${var.project_name}-node_group-${var.Environment}"
